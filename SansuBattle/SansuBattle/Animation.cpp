...
bool Animation::CreateList()
{
	...
	//***************************** ダメージのアニメーション *****************************************
	w.resize(ANIM_DAMEGE_ALL_CNT);
	Path = ANIM_DIR;
	Path += ANIM_NAME_DAMEGE;

	//読み込み
	LoadDivGraph(Path.c_str(), ANIM_DAMEGE_ALL_CNT, ANIM_DAMEGE_YOKO_CNT, ANIM_DAMEGE_TATE_CNT, ANIM_DAMEGE_WIDTH, ANIM_DAMEGE_HEIGHT, &w.front());
